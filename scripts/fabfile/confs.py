...
confs = {
    ...
    "lineitem100": {
        'TYPE' : SERVER,
        # 'INPUTSDIR' : '/data/mdindex/lineitem100/',
        'INPUTSDIR' : 'hdfs://istc13.csail.mit.edu:9000/user/amoeba/lineitem100-raw/',
        'TABLENAME' : 'lineitem100',
        'SAMPLINGRATE' : '0.005',
        'DELIMITER': '|',
        'NUMBUCKETS' : '512',
        'NUMTUPLES' : '600000000',
    ...
    "local_tpch_hdfs" : {
        'TYPE' : LOCAL,
        'INPUTSDIR' : 'hdfs://localhost:9000/user/amoeba/uploadtest/',
        'TABLENAME' : 'tpch',
        'SAMPLINGRATE' : '0.1',
        'DELIMITER': '|',
        'NUMBUCKETS' : '16',
    ...
    "tpch_10": {
        'TYPE' : SERVER,
        'TABLENAME' : 'tpch',
        'INPUTSDIR' : '/data/mdindex/tpchd10/',
        'HADOOPBIN' : '~/hadoop-2.6.0/bin/',
        'SAMPLINGRATE' : '0.002',
        'DELIMITER': '|',
        'NUMBUCKETS' : '512',
